 ...
 * 1) Set a break point in ConnectorsCodegenGenerator.java in the postProcessOperationsWithModels() method.
...
public class ConnectorsCodegenGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("connectors-codegen") // use this codegen library
              ...
              .setOutputDir("out/connectors-codegen"); // output directory
